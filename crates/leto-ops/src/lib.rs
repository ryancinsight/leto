...
pub use infrastructure::cache::{cache_geometry, cached_cache_geometry, CacheGeometry, MatmulTilePolicy};
...
pub use application::matrix::{
    batched_matmul, matmul, matmul_accumulate, matmul_with_tile_policy,
};
