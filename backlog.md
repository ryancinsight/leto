...
- Batch specialization: four batch entries permit inlining while square entries stay shared. Format, Clippy, 30 focused tests in debug/release, 25 doctests and rustdoc pass at 316 unchanged inputs. [Evidence](../../output/apollo-square-transpose/batch-specialization/leto-gates/final-checks.json); consumer codegen/size acceptance remains pending.
