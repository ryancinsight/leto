...
Update 2026-06-12 (v0.18.0): §A indexed zip parity, the Stage A1
...
dependency is wired through `leto_ops::CacheGeometry`; matmul blocking still
needs a measured kernel change before it can consume that geometry. See
CHANGELOG and the two ADRs in `docs/adr/`. Remaining work is cross-cutting:
