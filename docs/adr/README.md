...
| [0012](0012-dqds-values-only-singular-values.md) | ADR 0012 — Values-only singular values: dqds vs the bidiagonal Givens QR sweep | — |
...
| [0031](0031-cfdrs-cfd-math-fd-iterative-ssot-consolidation.md) | Remove CFDrs `cfd-math` finite-difference wrapper and clarify the `linear_solver` SSOT boundary | — |
| [0032](0032-kwavers-linear-algebra-wrapper-closure.md) | Close Kwavers `kwavers-math` `linear_algebra::{ext, complex}` trivial wrappers | — |
| [0033](0033-kwavers-3d-finite-difference-staggered-completion.md) | Complete kwavers 3-D finite-difference staggered-grid migration to leto-ops | — |
| [—](sparse-support-design.md) | ADR: Sparse Array Support in Leto and Hephaestus | Accepted for sparse storage and kernels. Solver ownership was superseded by |
